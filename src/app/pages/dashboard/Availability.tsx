    ...
    <div className="space-y-6 animate-fade-in max-w-2xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configura los días y horarios en que atiendes. Tus clientes solo podrán reservar en estos horarios.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {daysOfWeek.map((day) => (
            <div key={day.key} className="flex items-center gap-4 p-3 rounded-lg border bg-card">
              <Switch
          ...
          <Button onClick={() => toast.success("Disponibilidad guardada")} className="mt-4">
