...
export async function saveAvailabilityAction(userId: string, data: UpsertAvailabilityDTO) {
  try {
    ...
    return { success: false, error: error.message || "Error al guardar la disponibilidad" };
  }
}
